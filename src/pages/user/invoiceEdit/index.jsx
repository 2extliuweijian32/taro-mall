...
function InvoiceEdit() {
  ...
  return (
    <View className="invoice-edit">
      <View>
        <View className="edit-row clearfix">
          <View className="edit-row__label left">单位名称：</View>
        ...
        <View className="edit-row clearfix">
          <View className="edit-row__label left">纳税人识别码：</View>
          <View className="edit-row__value left">
            <Input
              className="form-control"
        ...
        <View className="edit-row clearfix">
          <View className="edit-row__label left">注册地址：</View>
          <View className="edit-row__value left">
            <Input
              className="form-control"
              placeholder="请输入注册地址"
        ...
        <View className="edit-row clearfix">
          <View className="edit-row__label left">注册电话：</View>
          <View className="edit-row__value left">
            <Input
              className="form-control"
              placeholder="请输入注册电话"
        ...
        <View className="edit-row clearfix">
          <View className="edit-row__label left">开户银行：</View>
          <View className="edit-row__value left">
            <Input
              className="form-control"
              placeholder="请输入开户银行"
        ...
        <View className="edit-row clearfix">
          <View className="edit-row__label left">银行账户：</View>
          <View className="edit-row__value left">
            <Input
              className="form-control"
              placeholder="请输入银行账户"
