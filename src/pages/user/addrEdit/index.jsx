  ...
  return (
    <View className="addr-edit">
      <View className="edit-row clearfix">
        <View className="edit-row__label left">收货人：</View>
      ...
      <View className="edit-row clearfix">
        <View className="edit-row__label left">手机号码：</View>
        <View className="edit-row__value left">
          <Input
            className="form-control"
            placeholder="请输入手机号码"
      ...
      <View className="edit-row clearfix">
        <View className="edit-row__label left">所在地区：</View>
        <View className="edit-row__value left">
          <Picker
            className="form-control"
            mode="region"
          ...
          >
            <View className="display-text ellipsis">
      ...
      <View className="edit-row clearfix">
        <View className="edit-row__label left">详细地址：</View>
        <View className="edit-row__value left">
          <Input
            className="form-control"
            placeholder="请输入详细地址"
